      ...
      <div className="row">
        ...
        <div className="col-lg-2 col-md-6 col-sm-6">
          <div className="widget">
            ...
            <ul className="widget_links">
              <li><a ng-reflect-router-link="account"><NavLink to='/account'>My Account</NavLink></a></li>
              <li><a ng-reflect-router-link="terms"><NavLink to='/terms'>Terms</NavLink></a></li>
              <li><a ng-reflect-router-link="signin"><NavLink to='/signin'>SignIn</NavLink></a></li>
              <li><a ng-reflect-router-link="signup"><NavLink to='/signup'>Signup</NavLink></a></li>
            </ul>
          </div>
        </div>
